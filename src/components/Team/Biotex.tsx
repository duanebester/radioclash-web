...
export const Biotex = () => {
  return (
    <div id="partner" className="relative bg-gray-100 overflow-hidden">
      <div className="max-w-7xl mx-auto py-10">
        <h1 className="text-2xl text-center py-8 font-extrabold text-gray-900">Our Partner</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto px-4">
          <div className="flex flex-col items-center font-extrabold text-gray-600">
            ...
            <p className="text-center font-thin mt-1">Premier medtech product development accelerator</p>
          </div>
          <Card
            photo={ashok}
          ...
          />
          <Card photo={manish} name="Manish Ahuja" title="Board of Directors Observer" desc="CEO BioTex, Inc." />
        </div>
      </div>
    </div>
  )
