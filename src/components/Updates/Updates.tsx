  ...
  return (
    <div className="grid grid-cols-6 gap-10 m-4">
      <div className="flex justify-center">
        <img className="w-28 max-h-20 object-contain" src={image} />
      </div>
    ...
    <div id="home" className="relative bg-gray-100 overflow-hidden">
      <div className="max-w-7xl mx-auto py-10">
        ...
        <Update
          ...
          image={medtech}
          desc="Advanced to West Coast RoadTour pitch cohort with a successful pitch at UCLA in early March '25. We will receive new if we have made it to the Finals in June."
        />
      </div>
    </div>
  )
